...
public class SimulationBuilder {
	...
	// here we are processing the simulation block from the ComponentType in the 
	// context of a specific component (target) and populating the StateType for that 
	// component
	// Essentially we just map the parts of the simulation block onto elements in jld.hrun
	// and connect up some references.
	// later on we will traverse the tree of StateInstances and extract the simulation elements
