...
public class StateInstance implements StateRunnable {
	...
	public void initialize(StateRunnable parent) throws RuntimeError, RuntimeError {
		currentTime = 0;
	...
	public void evaluate(StateRunnable parent) throws RuntimeError, RuntimeError {
		if (!built) {
	...
	public void advance(StateRunnable parent, double t, double dt) throws RuntimeError, RuntimeError {
		if (!built) {
			throw new RuntimeError("advance() called before build on " + this);
		}
...
//		String msg = ("adding mi " + mi + " to " + this);
	...
	public StateRunnable getChildInstance(String snm) throws RuntimeError {
		...
		if (hasChildInstance(snm)) {
			...
			throw new RuntimeError("seeking child instance " + snm + " in " + this + " but there are no children");
		}
		return ret;
	}
	
	
	public boolean hasChildInstance(String snm) throws RuntimeError {
		boolean ret = false;
	...
	public StateRunnable getPathStateInstance(String pth) throws RuntimeError {
		if (!resolvedPaths) {
	...
	void makeIDSIHM() {
		...
		public String getPathStringValue(String path, double fac, double off) throws RuntimeError, RuntimeError {
			String ret = "";
	...
	public void addPathStateArray(String pth, ArrayList<StateRunnable> pla) throws RuntimeError {
	...
	public ArrayList<StateRunnable> getPathStateArray(String pth) throws RuntimeError {
		if (!resolvedPaths) {
	...
	public void addAttachment(StateInstance inst) throws ConnectionError, RuntimeError, RuntimeError {
		addAttachment(null, inst);
	}
		
	public void addAttachment(String s, StateInstance inst) throws ConnectionError, RuntimeError, RuntimeError {
		String snm = s;
	...
	public ArrayList<StateRunnable> getStateInstances(String path) throws ConnectionError, RuntimeError, RuntimeError {
	...
	public ArrayList<StateRunnable> quietGetStateInstances(String path) throws ConnectionError, RuntimeError, RuntimeError {
	...
	public ArrayList<StateRunnable> getStateInstances() throws ConnectionError, RuntimeError, RuntimeError {
		checkBuilt();
		ArrayList<StateRunnable> ret = null;
 		if (singleAMI) {
	...
	public void checkBuilt() throws ConnectionError, RuntimeError, RuntimeError {
	...
	public InstanceSet<StateRunnable> getUniqueInstanceSet() throws RuntimeError {
		...
		if (ret == null) {
			...
			throw new RuntimeError("Can't get single instance set from " + this + " " + msg);
		}
		return ret;
	}
	...
	public ArrayList<StateRunnable> getPathInstances(String sel) throws RuntimeError, ConnectionError, RuntimeError {
		ArrayList<StateRunnable> ret = null;
		...
		if (ret == null) {
			throw new RuntimeError("cant find '" + sel + "' in " + this);
		}
		return ret;
	}

	public double getFloatProperty(String sel) throws RuntimeError {
		...
		if (Double.isNaN(ret) || Double.isInfinite(ret)) {
			throw new RuntimeError("no such property " + sel + " in " + this);
		}
		return ret;
	}

	public double quietGetFloatProperty(String sel) throws RuntimeError {
		double ret = Double.NaN;
	...
	public String getTypeParam(String satt) throws RuntimeError {
