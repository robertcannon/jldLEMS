...
public class RunnableAccessor {
	...
	public StateWrapper getStateWrapper(String path) throws ConnectionError, RuntimeError {
...
//				ret = ((MultiInstance)wk).getPredicateInstance(lastbit);
	...
	public ArrayList<StateRunnable> getRelativeStateInstances(StateRunnable base, String path) throws ConnectionError, RuntimeError {
	...
	public ArrayList<StateRunnable> getStateInstances(String path) throws ConnectionError, RuntimeError {
